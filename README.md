...
- Consulta por email, username, dominio, URLs afectadas dirección IP o teléfono
...
|--------------|--------------------|------|-------|
|Kali Linux| 2025.4| si| funcionando   |
|Parrot Security OS| 7.0| si | funcionando   |
|Windows| 11 | si | funcionando   |
|BackBox| 9 | si | funcionando   |
|Arch Linux| 2026.01.01 | si | funcionando   |
